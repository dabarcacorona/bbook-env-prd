...
public class csvBbookSdiprcehi {


    private String[] csvLine;

    private csvBbookSdiprcehi() {
    }

    public csvBbookSdiprcehi(bbookSdiprcehi bbooksdiprcehi) {

        setCsvLine(bbooksdiprcehi);
    ...
    public static String[] getHeader() { // getProtectedFieldsFromSuperClass() {
        ...
        return csvBbookSdiprcehi.getProtectedFieldsFromClass(bbookSdiprcehi.class);
