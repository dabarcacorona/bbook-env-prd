...
public class csvBbookSdivpccsi {
    private String[] csvLine;

    private csvBbookSdivpccsi() {
    }

    public csvBbookSdivpccsi(bbookSdivpccsi bbooksdivpccsi) {

        setCsvLine(bbooksdivpccsi);
    ...
    public static String[] getHeader() { // getProtectedFieldsFromSuperClass() {
        ...
        return csvBbookSdivpccsi.getProtectedFieldsFromClass(bbookSdivpccsi.class);
