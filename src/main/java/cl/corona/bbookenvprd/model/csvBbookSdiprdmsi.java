...
public class csvBbookSdiprdmsi {
    private String[] csvLine;

    private csvBbookSdiprdmsi() {
    }

    public csvBbookSdiprdmsi(bbookSdiprdmsi bbooksdiprdmsi) {

        setCsvLine(bbooksdiprdmsi);
    ...
    public static String[] getHeader() { // getProtectedFieldsFromSuperClass() {
        ...
        return csvBbookSdiprdmsi.getProtectedFieldsFromClass(bbookSdiprdmsi.class);
